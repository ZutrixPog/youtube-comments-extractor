...
class CommentDownloader:
    ...
    async def make_request(self, endpoint, ytcfg, retries=5, sleep=20):
        ...
        for _ in range(retries):
            response = await self.session.post(url, params={'key': ytcfg['INNERTUBE_API_KEY']}, json=data)
    ...
    async def get_comments_from_url(self, youtube_url, sort_by=SORT_BY_RECENT, language=None, sleep=.1):
        ...
        while continuations:
            ...
            response = await self.make_request(continuation, ytcfg)
